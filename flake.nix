{
  ...
  inputs = {
    ...
    meta-signal-persona.inputs.crane.follows = "crane";
    ...
    in
    {
      ...
      checks = forSystems (
        ...
        in
        {
          ...
          meta-signal-persona-test = inputs.meta-signal-persona.checks.${system}.test;
          meta-signal-persona-datom = inputs.meta-signal-persona.checks.${system}.test-datom;
          meta-signal-persona-doc = inputs.meta-signal-persona.checks.${system}.doc;
          meta-signal-persona-fmt = inputs.meta-signal-persona.checks.${system}.fmt;
          meta-signal-persona-clippy = inputs.meta-signal-persona.checks.${system}.clippy;
          meta-signal-persona-no-free-functions = inputs.meta-signal-persona.checks.${system}.no-free-functions;
          meta-signal-persona-no-inherent-methods = inputs.meta-signal-persona.checks.${system}.no-inherent-methods;
          ...
          signal-system-datom = inputs.signal-system.checks.${system}.test-datom;
